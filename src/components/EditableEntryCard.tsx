...
import { deleteEntry, getProjects, toggleSynced, updateEntry } from "../lib/commands";
...
export function EditableEntryCard({ entry, onUpdate }: Props) {
  ...
  return (
    <div className={`detail-entry-card area-left-${areaClass} ${entry.synced ? "is-synced" : ""}`} onClick={() => setEditing(true)} style={{ cursor: "pointer" }}>
      <div className="detail-entry-top">
        ...
        <div className="detail-entry-actions">
          ...
          <button className="detail-entry-delete" onClick={handleDelete} title="Delete entry">
            &times;
          </button>
        </div>
      </div>
